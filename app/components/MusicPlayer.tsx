    ...
    <div className="mp-wrapper mp-desktop">
      ...
      >
        <div className={`mp-links-tray ${linksOpen ? 'mp-links-open' : ''}`}>
          ...
          <a href="https://arrythmia.isaacrozsa.com" target="_blank" rel="noopener noreferrer" className="mp-link-icon" aria-label="Arrythmia" onClick={e => e.stopPropagation()}>
    ...
    <div className={`mp-mobile-wrap mp-mobile-container ${mobileOpen ? 'mp-mobile-expanded' : 'mp-mobile-collapsed'}`}>
      ...
      <div className={`mp-mobile-body ${mobileOpen ? 'mp-mobile-body-open' : ''}`}>
        ...
        <div style={{ display: 'flex', gap: 20, justifyContent: 'center' }}>
          ...
          <a href="https://arrythmia.isaacrozsa.com" target="_blank" rel="noopener noreferrer" className="mp-link-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><polygon points="12,4 22,20 2,20" stroke="#2563eb" strokeWidth="1.5" fill="none"/><rect x="10" y="2" width="4" height="4" fill="white" stroke="#2563eb" strokeWidth="0.8"/><rect x="20" y="18" width="4" height="4" fill="white" stroke="#2563eb" strokeWidth="0.8"/><rect x="0" y="18" width="4" height="4" fill="white" stroke="#2563eb" strokeWidth="0.8"/></svg></a>
